...
if isempty(PARAM.Ca)
    ...
    if PARAM.algorithm==1
        ...
        elseif PARAM.ellipseShape==2
            filename = [nameShort 'oneDropBEM_ODE=' num2str(ODE) '_n=' num2str(PARAM.n) '_BC=' num2str(PARAM.typeBCstokes) '_Bo=' num2str(PARAM.Bond) '_visc=' num2str(PARAM.visc) '_ID=' num2str(PARAM.IDsim) '_maxDT=' num2str(maxDT) '_Tend=' num2str(Tend) '.mat'];
        end

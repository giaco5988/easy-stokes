...
function status = tutorial_checkCoeffsAndConvergence(t,xyMode,flag,PARAM,V0)
    ...
    if status==0
        ...
        if PARAM.checkRes==1
            ...
            if PARAM.legendre==1||PARAM.legendre==2
                %compute residulas
                [~,res] = tutorial_dropLegendreCurvilinearModes(0,xyMode,PARAM);
            elseif PARAM.legendre==0
                [~,res] = tutorial_dropExtensChebfunCurvilinearModes(0,xyMode,PARAM);
            end

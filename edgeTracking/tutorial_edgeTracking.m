...
function [Tedge,Yedge] = tutorial_edgeTracking(Tsave,maxDT,initialDT,PARAM,V0)
...
for l = loopStart:loops
    ...
    myOut1 = @(t,y,flag) tutorial_checkCoeffsAndConvergence(t,y,flag,PARAM,V0);
    eventRemesh = @(t,y) eventSpectralRemesh(t,y,PARAM);

    %nonlinear function
    f = tutorial_functionDropSpectral(PARAM);

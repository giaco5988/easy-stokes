...
function [uMode,nx,ny,x,y,firstMode,K1,K2] = tutorial_NormalVelocitySpectralVolumeXY2modes(perturb,xBase,yBase,V0,xcm,PARAM)
    ...
    %compute solution
    [sol,nxGrid,nyGrid,~,K1,K2] = tutorial_bemSpectralXY(x,y,PARAM);

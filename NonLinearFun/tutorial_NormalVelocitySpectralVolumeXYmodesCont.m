...
function [uMode,nx,ny,x,y] = tutorial_NormalVelocitySpectralVolumeXYmodesCont(perturb,xBase,yBase,V0,xcm,PARAM,Ca)
    ...
    %compute solution
    [sol,nxGrid,nyGrid] = tutorial_bemSpectralXY(x,y,PARAM);

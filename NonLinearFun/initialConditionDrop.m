...
if PARAM.uploadShape==0
    ...
    elseif PARAM.algorithm==1||PARAM.algorithm==2||PARAM.algorithm==6
        ...
        elseif PARAM.shapeEllipse==5
            %build sphere perturb by N legendre polynimials
            [x,y] = spherePlusNLegendreCurvilinearAsymmetric(PARAM.remeshMapping(PARAM.t),PARAM.D,PARAM);
        end

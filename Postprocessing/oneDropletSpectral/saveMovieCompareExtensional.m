...
function saveMovieCompareExtensional(Tstore,Ystore,ElongStore,f1Store,f2Store,color,stepSave,nameNorm,namePhase,nameShape,saveLoop,savePlotEnd,solidLine,PARAM,saveDest,saveMovie)
...
for i = saveLoop
    ...
    count = 0;
    for hhh = 1:stepSave(i):max(numel(T))
        ...
        display(['Save ' nameNorm ' ' num2str(count) ' of ' num2str(numel(1:stepSave(i):max(numel(T))))])
...
for i = saveLoop
    ...
    count = 0;
    for hhh = 1:stepSave(i):max(numel(f1))
        ...
        display(['Save ' namePhase ' ' num2str(count) ' of ' num2str(numel(1:stepSave(i):max(numel(f1))))])
...
for i = saveLoop
    ...
    for hhh = 1:stepSave(i):indFinal
        ...
        %display
        display(['Save ' nameShape ' ' num2str(count) ' of ' num2str(numel(1:stepSave(i):indFinal))])

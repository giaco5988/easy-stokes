...
min_dir = '~/Documents/MATLAB/droplet_simulations/results/extensional/minimize/';
...
%     hold off
    ...
    try
    filename = [min_dir 'ExtensDroplet_elem=50_lambda=' num2str(visc) '.mat'];
    load(filename)
    allDnewton = manyD;
    allCanewton = manyCa;
    catch

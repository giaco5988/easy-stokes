...
PARAM.D = [0.2 0.1 0.3];                                              % deformation parameter of the initial condition

% in case the initial shape is analytical, choose how to draw it
PARAM.shapeEllipse = 5;                                      % 0 initial shape is sphere plus P2 Legendre, 1 initial shape is an ellipse, 2 is pertubed with 2 legendre polynomials P2 P4, 3 is asymmetric shape by P3 Legendre, 4 is P2, P3
...
PARAM.BC = 2;                                       % BC: 1 is linear extensional flow, 2 is rising droplet, 3 is nonlinear extensional flow
...
Tend = 20;             % end of simulation
maxDT = 1e-3;           % set max time step

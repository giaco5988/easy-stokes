...
%% PHYSICAL PARAMETERS
PARAM.Ca = 0.01;                                       % capillary number
...
PARAM.dealiasing = 25;  ratioGrid = 2;                  % dealiasing
...
PARAM.ResBreak = 1e-6;                  % break when residuals are smaller
PARAM.stop = 10;                        % stop after maximum iteration
...
PARAM.CaBreakDown = 0.0;                                                  % break when Ca is smaller
PARAM.changeSystemOfCoord = 1;    PARAM.howOften = 1;                      % change system of coordinates every continuation iteration
PARAM.switchBranch = 0;   PARAM.deltaSwitch  = 0.1;    PARAM.deltaDir = 1; % for branch switching
PARAM.isSing = 1e-3;      PARAM.checkOnlyOnePitchfork = 1;                 % try switching branch when getting neutral eigenvalue in the Jacobian
...
%% CHOOSE FILENAME
PARAM.algorithm = 4;    % continuation method

...
PARAM.n = 20;                    % number of element per panel
PARAM.typePanel = [1 1];         % 0 is a straight line
...
[yOut,Xsing,Ysing] = BEM_Laplace(x,y,PARAM);
...
PARAM.velBC{1} = vSlip;%    PARAM.velBC{2} = vSlip2;
PARAM.stressBC{1} = 0;%      PARAM.stressBC{2} = 0;
PARAM.panelType = [1 1];                                % 0 is fixed wall, 1 is moving wall, 2 is droplet (this decide the coefficient of the BIE)
